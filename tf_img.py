...
data_dir = pathlib.Path('C:/Users/gianm/.keras/datasets/vehicle_photos2')
...
#%% Predict new data
image_url = "https://d1ix0byejyn2u7.cloudfront.net/drive/images/uploads/panel-images/Traffic_cameras_help.jpg"
image_path = tf.keras.utils.get_file('img-' + id_generator(), origin=image_url)
